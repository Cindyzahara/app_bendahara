...
class T3Tkn extends Model
{
    use HasFactory;
    protected $table = "t3tkn";
    protected $primaryKey = "id";
    protected $fillable= [
    'id ', 'tanggal1', 'nama', 'nominal', 'pembayaran1', 'sisa1', 'tanggal2', 'pembayaran2', 'sisa2', 'tanggal3', 'pembayaran3', 'sisa3', 'tanggal', 'pembayaran4', 'sisa4', 'tanggal5', 'pembayaran5', 'sisa5'];
